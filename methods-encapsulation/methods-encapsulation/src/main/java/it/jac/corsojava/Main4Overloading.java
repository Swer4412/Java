...
public class Main4Overloading {
	//Overloading vuol dire chiamare molte funzioni con lo stesso nome (con parametri diversi però)
...
//		somma((Integer)n1, (Integer)n2); //Se converti due int in Integer, la funzione usata è quella che accetta Integer
...
//	NON COMPILA perch� il nome e i parametri sono gli stessi presenti in un altro metodo
